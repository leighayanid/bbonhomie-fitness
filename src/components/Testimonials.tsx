...
const testimonials = [
  {
    ...
    quote: "I thought I knew how to train until I joined. The intensity is unmatched. Added 15lbs of stage weight in one off-season. This isn't coaching; it's a metamorphosis.",
    rating: 5,
  },
  {
    id: 2,
    ...
    quote: "I was tired of cookie-cutter plans. Here, everything is calculated. My nutrition, my training, my recovery. I've never looked this good, but more importantly, I've never felt this strong.",
    rating: 5,
  },
  {
    id: 3,
    name: "David K.",
    role: "Executive",
    quote: "I need efficiency. I don't have hours to waste. The protocol is brutal but effective. 45 minutes of hell, zero wasted movement. Best investment I've made for myself.",
    rating: 5,
  },
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-5xl md:text-7xl font-bebas text-white mb-4">
            VOICES OF THE <span className="text-transparent text-stroke">BROTHERHOOD</span>
          </h2>
