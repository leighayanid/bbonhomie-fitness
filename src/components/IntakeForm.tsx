...
type FormData = {
  ...
  email: string;
  instagram: string;
  goal: "competition" | "muscle" | "weight_loss" | "lifestyle";
  dedication: number;
  why: string;
};
    ...
    <section id="contact" ref={sectionRef} className="py-24 bg-zinc-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-3xl relative z-10">
        ...
        <form ref={formRef} onSubmit={handleSubmit(onSubmit)} className="space-y-8 bg-zinc-900/40 p-8 md:p-12 border border-white/10 backdrop-blur-md shadow-2xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                >
                  <option value="competition" className="bg-zinc-900">Competition Prep</option>
                  <option value="muscle" className="bg-zinc-900">Build Muscle</option>
                  <option value="weight_loss" className="bg-zinc-900">Lose Weight</option>
                  <option value="lifestyle" className="bg-zinc-900">Healthy Lifestyle</option>
                </select>
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold text-gray-400 uppercase tracking-widest">How can we help you?</label>
            <textarea
